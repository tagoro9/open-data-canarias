    ...
    function getHotspotsRestauracion( $db, $value ) {
        ...
        // Put each POI information into $hotspots array.
            foreach ( $rawPois as $rawPoi ) {
                $poi = array();
                $poi['id'] = $rawPoi['id'];
                $url = 'http://augwesome-reality.herokuapp.com/img/'.strtolower(str_replace(' ', '', $rawPoi['description'])).'.png';
                $poi['icon']['url'] = $url;
                $poi['imageURL'] = $url;
    ...
    function getHotspotsAlojamiento( $db, $value ) {
        ...
        // Put each POI information into $hotspots array.
            foreach ( $rawPois as $rawPoi ) {
                $poi = array();
                $poi['id'] = $rawPoi['id'];
                $url = 'http://augwesome-reality.herokuapp.com/img/'.strtolower(str_replace(' ','', $rawPoi['Categoria'])).'.png';
                $poi['icon']['url'] = $url;
                $poi['imageURL'] = $url;
                //$poi['object']['contentType'] = 'image/png';
                //$poi['object']['url'] = $url;
